...
async def start(client,message):
	...
	await message.reply_text("Hello iam Pdisk Uploader Bot\nMade with love by @moviezbarn",reply_to_message_id = message.message_id,reply_markup=InlineKeyboardMarkup([ [ InlineKeyboardButton("Support 🇮🇳" ,url="https://t.me/moviezbarn") ], [InlineKeyboardButton("Subscribe 🧐", url="https://www.telegram.dog/moviezbarn") ]  ]  ) 
        )
